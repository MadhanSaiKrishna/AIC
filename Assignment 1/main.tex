...
\begin{figure}[H]
    ...
    \caption{Intrinsic Gain ($g_m r_o$) for SCL180nm technology node at Midband Frequency 1GHz}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Intrinsic Gain ($g_m r_o$) for TSMC180nm technology node at Midband Frequency 1GHz}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/3_b_ibm_gain.png}
    \caption{Intrinsic Gain ($g_m r_o$) for IBM130nm technology node at Midband Frequency 1GHz}
\end{figure}
